...
Install `mami.call` package by running:

```shell script
pip3 install mami.call
```
...
>Running `mami.call.sh` as sudo miscofigures files ownership. It is recommended not to run it as sudo
...
git clone https://github.com/mamitab/mami.call.git
cd mami.call
./mami.call.sh
```
...
**A:** There is no official website/app yet.The only official releases of TBomb are published in [Github](https://github.com/mamitab/mami.call) and [PyPi](https://pypi.org/project/mami.call)
##
...
**A:** Due the amount of requests, the APIs can die. To prevent a bigger outtake of mami.call, it has been limited. 
##
...
- The Easy Method:  
   `pip3 install mami.call`  
    Then execute by simply running `mami.call`
- The Git Method:  
    Clone the repo and Switch to the TBomb Directory and execute this command:  
    `pip3 install -r requirements.txt`
##
**Q:** Help, It says `command 'mami.call' not found` after installing PIP version!

**A:** Try running `sudo pip3 install mami.call`
##
**Q:** Help, I can't execute mami.call.sh!

**A:** Run mami.call Directly with `python3 mami.call.py`
##
**Q:** Should I use VPN? 
