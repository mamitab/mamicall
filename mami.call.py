...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/mamitab/mami.call/archive/dev.zip"
        dir_name = "TBomb-dev"
    else:
        zip_url = "https://github.com/mamitab/mami.call/archive/master.zip"
    ...
    if success:
        ...
        mesgdcrt.FailureMessage("Unable to update mami.call")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/mamitab/mami.call.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/mamitab/mami.call.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/mamit/mami.call/master/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("mami.call is up-to-date")
        mesgdcrt.GeneralMessage("Starting mami.call")


def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/mamitab/mami.call/raw/dev/.notify"
        else:
            url = "https://githup.com/mamitab/mami.call/raw/master/.notify"
...
try:
    country_codes = readisdc(90)["isdcodes"]
...
parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by mamitab !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start mami.call with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start mami.call with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start mami.call with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update mami.call")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current mami.call contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current mami.call version")
